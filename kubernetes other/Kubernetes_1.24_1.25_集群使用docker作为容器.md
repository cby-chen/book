...
layout: post
cid: 283
title: Kubernetes 1.24 1.25 集群使用docker作为容器
slug: 283
date: 2022/09/02 19:07:12
updated: 2022/09/02 19:09:47
status: publish
author: cby
categories: 
  - 默认分类
tags: 
abstract: Kubernetes 1.24 1.25 集群使用docker作为容器
description: Kubernetes 1.24 1.25 集群使用docker作为容器
